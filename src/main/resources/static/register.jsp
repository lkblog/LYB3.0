...
<body>
	...
	<%
		String mes = (String) request.getAttribute("wrongMes");
	%>
				...
				<td colspan="3" height="162">
					<table width="100%" border="0" cellpadding="2" cellspacing="2"
						...
						<tr>
							...
							<td height="30"><span class="font0">男孩</span> <input
								type="radio" name="sex" value="0" checked> <span
								class="font0">女孩</span> <input type="radio" name="sex" value="1"></td>
						</tr>
						<tr>
						...
						<tr>
							<td height="21" colspan="2" align="center"><span
								class="font0"><input type="submit" value="注册" /> <input
									type="reset" /></span></td>
						</tr>
					</table>
				</td>
